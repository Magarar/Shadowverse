...
namespace Menu
{
    ...
    public class StarterDeckPanel:UIPanel
    {
        ...
        private void ChooseDeck(string deckID)
        {
            if (Authenticator.Get().IsTest())
                ChooseDeckTest(deckID);
            if (Authenticator.Get().IsApi())
                ChooseDeckApi(deckID);
        }
        ...
        private async void ChooseDeckTest(string deck_id)
        {
            ...
            udeck.hero = new UserCardData(deck.hero, deck.hero.GetVariant());
        ...
        private async void ChooseDeckApi(string deckID)
        {
